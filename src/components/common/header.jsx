            ...
            <header className="sticky top-0 z-9999 py-[22px] bg-black">
                <div className="container">
                    <nav className="flex items-center justify-between">
                        ...
                        <ul className={` py-12 lg:py-0 px-6 lg:px-0  flex flex-col gap-4 lg:gap-none lg:flex-row items-center absolute lg:static left-0 top-[80px] w-full lg:w-auto h-screen lg:h-auto bg-black lg:bg-transparent transition-all duration-500 ease-in-out
  ${isMenuOpen ? "opacity-100 visible" : "opacity-0 invisible lg:visible lg:opacity-100"}`}>
                            {Navlinks.map(link => (
                                <li key={link.name}>
                            ...
                            <Button
                                ...
                                className="flex sm:hidden w-[190px] border border-[#f3fe00] bg-[#f3fe00] transition-[background-color,border-color] duration-500 ease-in-out hover:bg-black text-black hover:text-[#f3fe00] "
                            />

                        </ul>
                        <div className="flex items-center gap-3">
                            <button className="p-1 bg-white rounded-[16px] w-[52px] h-[32px] cursor-pointer relative">
                                <div className="w-[26px] h-[26px] bg-black rounded-full absolute left-[3px] top-[3px] flex items-center justify-center">
