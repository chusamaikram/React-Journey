        ...
        <>
            <div className=" relative p-6 sm:p-10 h-[162px] border-t border-t-[#2D2D2D] border-b border-b-[#2D2D2D] hover:border-l-[#2D2D2D] group ">
                ...
                <div className="absolute right-30 top-0 opacity-0 translate-x-[-20px] transition-all duration-900 ease-in-out group-hover:opacity-70 group-hover:translate-x-20">
                    <img src={cardbg} alt="card-bg" className="w-full h-full object-cover" />
                </div>
                <div className="z-10 flex items-center justify-between ">
                    ...
                    <Link to={path} className="w-12 h-12 flex items-center justify-center p-2.5 rounded-full bg-[#2D2D2D] border border-[#2D2D2D] translate-x-[24px] sm:translate-x-[40px] transition-all duration-900 ease-in-out group-hover:translate-x-0 group-hover:bg-white group-hover:text-black">
