                    ...
                    <div className="flex flex-col lg:flex-row items-start justify-center gap-8 sm:gap-16">
                        <div className="flex flex-col items-start justify-center gap-8">
                            ...
                            <div className="max-w-[534px] flex flex-col items-start gap-4">
                                <h2 className="text-[28px] sm:text-[40px] font-bold leading-[40px] sm:leading-[44px] font-[Geologica]">Lets work on what you care about!</h2>
                                <p className="text-[#BDBDBD] text-sm leading-[21px]">Got a project in mind? From a full UI/UX refresh to a brand-new digital experience, we're ready to help. Let's turn your vision into reality</p>
                            </div>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-center gap-6">

                                <div className="flex items-center gap-4">
                                    <img src={ali} className=" rounded-full border border-[#454545]" width={48} height={48} loading="lazy" />
                                    <div className="flex flex-col items-start gap-1.5 ">
                                        <h3 className="flex items-center gap-2 text-base font-medium leading-[21px] font-['Inter_Tight']">
                                            <span>Mohammad Ali</span>
                                            <a href="https://www.linkedin.com/in/mohammad-ali-ui-ux-consultant/" target="blank"> <LinkdelnMini /></a>
                                        </h3>
                                ...
                                <div className="flex items-center gap-4" >
                                    <img src={babar} className=" rounded-full border border-[#454545]" width={48} height={48} loading="lazy" />
                                    <div className="flex flex-col items-start gap-1.5 ">
                                        <div className="flex items-center gap-2">
                                            <h3 className=" text-base font-medium leading-[21px] font-['Inter_Tight']"> Muhammad Babar</h3>
                                            <a href="https://www.linkedin.com/in/muhammadbabar-uxui/" target="blank"> <LinkdelnMini /> </a>
                                        </div>
                        ...
                        <form className="w-full  sm:w-[540px] p-4 sm:p-6  flex flex-col items-start gap-7 bg-[rgba(255, 255, 255, 0.05)] rounded-[24px] border border-[#3C3C3C] ">
                            < InputField type="text" name="name" placeholder="Full Name*" />
                            < InputField type="email" name="email" placeholder="Email*" />
                            < InputField type="text" name="company" placeholder="Company" />
                            < InputField type="tel" name="phone" placeholder="Contact" />
                            <textarea className="w-full p-4  bg-[#171717] border border-[#373737] focus:border-[#F3FE00] outline-none rounded-[8px] text-[#B9B9B9] text-sm font-medium font-['Inter_Tight'] h-[117px] resize-none" placeholder="Tell us about your project*"></textarea>
                            <button className="cursor-pointer px-5.5 py-3.5 my-1 bg-[#242323] border border-[#F3FE00] rounded-full  w-full flex items-center justify-center text-base font-semibold leading-[21px] text-white font-['Inter_Tight']">Submit Inquiry</button>
                            <div className="font-['Inter_Tight'] flex flex-col items-start gap-2">
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                    <a className="flex items-center gap-1.5" href="https://wa.me/+14232493851">
                                        ...
                                        <span className="text-[#BDBDBD] text-sm leading-[21px]">+14232493851</span>
                                    </a>
                                    <a className="flex items-center gap-1.5" href="mailto:businessmanager@zeeframes.com">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <span className="text-[#BDBDBD] text-sm leading-[21px]">businessmanager@zeeframes.com</span>
                                    </a>
                                </div>
                            </div>
