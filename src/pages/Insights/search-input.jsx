...
export default function SearchInput({ placeholder, ShowIcon = true, Ff='font-[Plus_Jakarta_Sans]' }) {
    return (
        <>
            <div className="w-[364px] h-[48px] p-1.5 ps-4.5 bg-white/10 border border-[#2D2D2D] rounded-full flex items-center justify-between relative ">
                <input type="search" placeholder={placeholder} className={`outline-none text-sm ${Ff} `} />
                {ShowIcon &&
