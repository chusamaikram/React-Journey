                    ...
                    <div className="container">
                        <div className="flex flex-col items-start">
                            <div className="text-[#CDCDCD]">
                                ...
                                <p className="text-base mt-5 leading-[24px] font-[Inter] text_gray_495">Five lessons I've learned about deliverables that Junior Designer Me could’ve never imagined.</p>
                            </div>
